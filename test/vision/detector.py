...
class Detector:
    ...
    def _detectar_elemento(self, frame, hsv_bajo, hsv_alto,
    ...
    def detectar_bananas(self, frame):
        ...
        return self._detectar_elemento(
            frame,
            cfg.BANANA_HSV_BAJO, cfg.BANANA_HSV_ALTO,
    ...
    def detectar_tronco(self, frame):
        ...
        return self._detectar_elemento(
            frame,
            cfg.TRONCO_HSV_BAJO, cfg.TRONCO_HSV_ALTO,
    ...
    def detectar_arbusto(self, frame):
        ...
        return self._detectar_elemento(
            frame,
            cfg.ARBUSTO_HSV_BAJO, cfg.ARBUSTO_HSV_ALTO,
    ...
    def detectar_kong(self, frame):
        ...
        return self._detectar_elemento(
            frame,
            cfg.KONG_HSV_BAJO, cfg.KONG_HSV_ALTO,
