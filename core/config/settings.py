...
PLATAFORMA_MADERA_RANGO_BAJO = [8, 150, 120]  
PLATAFORMA_MADERA_RANGO_ALTO = [18, 220, 220]
...
PLATAFORMA_MADERA_PROP_MAX = 2.0
PLATAFORMA_MADERA_ALTURA_STANDAR = 20  
PLATAFORMA_MADERA_ZONAS_Y = [139, 227, 315, 403]  
